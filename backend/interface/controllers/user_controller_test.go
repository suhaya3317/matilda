...
func (mockFirebase *MockFirebaseUserRepository) FindPublicKey(client *http.Client) (*http.Response, error) {
	publicKey := PublicKey{
...
func (mockFirebase *MockFirebaseUserRepository) ParseToken(idToken string, keys map[string]*json.RawMessage) (*jwt.Token, error) {
	return &jwt.Token{}, nil
}

func (mockFirebase *MockFirebaseUserRepository) FindSub(parsedToken *jwt.Token) (string, bool) {
